...
{
    public class HyperFeetItemAmmountDescription extends AbstractItemAmmountDescriptionWithAmountsArray
    {
        public function HyperFeetItemAmmountDescription()
        {
            super();
            
            amounts[ItemTypes.POWER_UP]    = 18;
            amounts[ItemTypes.BOMB_UP]    = 18;
            amounts[ItemTypes.SPEED_UP]    = 0;
            ...
            amounts[ItemTypes.SPEED_DOWN]    = 0;
            amounts[ItemTypes.SKULL]    = 5;
