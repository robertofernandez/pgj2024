package com.willdom.games.bomberman.gameobjects.items
{
    ...
    public class DefaultItemAmountDescription extends AbstractItemAmmountDescriptionWithAmountsArray
    {
        public function DefaultItemAmountDescription()
        {
            super();
            ...
            amounts[ItemTypes.SKULL] = 4;
            
            /*amounts[ItemTypes.POWER_UP] = 8;
            amounts[ItemTypes.BOMB_UP] = 8;
            amounts[ItemTypes.SPEED_UP] = 18;
            amounts[ItemTypes.MAX_POWER] = 4;
            amounts[ItemTypes.KICK_BOMB] = 4;
            amounts[ItemTypes.BOUNCING_BOMB] = 4;
            ...
            amounts[ItemTypes.BOMB_DOWN] = 5;
            amounts[ItemTypes.SPEED_DOWN] = 5;
            amounts[ItemTypes.SKULL] = 20;*/
            
            if (ConfigController.getInstance().gameTestingMode)
            {
                 amounts[ItemTypes.SKULL] = 20;
                 amounts[ItemTypes.BOMB_CHANGE] = 10;
            }
        }
    }
}